...
class 32EditarSensor(unittest.TestCase):
    def setUp(self):
    ...
    def test_32_editar_sensor(self):
        driver = self.driver
        ...
        driver.find_element_by_id("id_name").send_keys("Selenium-edited")
        Select(driver.find_element_by_id("id_su_survey")).select_by_visible_text("Selenium_edited")
        driver.find_element_by_id("save_sensor").click()

...
class ReporteSensorPdf(unittest.TestCase):
    ...
    def test_reporte_sensor_pdf(self):
        ...
        driver.find_element_by_xpath("(//a[@id=''])[3]").click()
        driver.find_element_by_xpath("//div[@id='content']/div[3]/div/ul/li[1]/a/p").click() #Acá se elige la Pauta 
        driver.find_element_by_xpath("//*[@id='content']/div[3]/div/ul/li[1]/a/h2").click() #Acá se elige si es PDF o cualquier otro tipo(PDF defecto)
        try: 

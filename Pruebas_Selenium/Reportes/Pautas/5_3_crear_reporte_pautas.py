...
class 53CrearReportePautas(unittest.TestCase):
    def setUp(self):
    ...
    def test_53_crear_reporte_pautas(self):
        driver = self.driver
        ...
        driver.find_element_by_link_text("Reporte en PDFDescargar reporte PDF").click()

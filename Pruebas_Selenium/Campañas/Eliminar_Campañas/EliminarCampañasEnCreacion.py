...
class TerminarDeCrearCampanas(unittest.TestCase):
    ...
    def test_terminar_de_crear_campanas(self):
        ...
        while True:
            ...
            driver.find_element_by_xpath("//ul[@id='menu1']/li/a/span[2]").click()
            try:
                ...
                print("No se puede continuar eliminando campañas en creacion, posiblemente ya no quedan...")
                break
            ...
            if(current_campaign.find(self.skip) == -1):
                ...
                print("Eliminando campaña en creacion --->" + current_campaign)

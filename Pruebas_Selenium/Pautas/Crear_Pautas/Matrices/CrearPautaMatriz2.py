...
class CrearPautaMatriz2(unittest.TestCase):
    def setUp(self):
    ...
    def test_crear_pauta_matriz2(self):
        driver = self.driver
        ...
        driver.find_element_by_id("id_title").send_keys("CrearPauta_Matriz_2")
        driver.find_element_by_id("id_subtitle").click()
        driver.find_element_by_id("id_subtitle").clear()
        driver.find_element_by_id("id_subtitle").send_keys("CrearPauta_Matriz_2")

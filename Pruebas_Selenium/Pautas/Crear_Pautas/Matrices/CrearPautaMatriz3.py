...
class CrearPautaMatriz3(unittest.TestCase):
    def setUp(self):
    ...
    def test_crear_pauta_matriz3(self):
        driver = self.driver
        ...
        driver.find_element_by_id("id_title").send_keys("CrearPauta_Matriz_3")
        driver.find_element_by_id("id_subtitle").clear()
        driver.find_element_by_id("id_subtitle").send_keys("CrearPauta_Matriz_3")
        driver.find_element_by_xpath("//form[@id='survey_template_create']/div[2]/div/ul/li[4]/div/label/span[3]").click()
        driver.find_element_by_xpath("//form[@id='survey_template_create']/div[2]/div/ul/li[5]/div/label/span").click()
        driver.find_element_by_xpath("//form[@id='survey_template_create']/div[2]/div/ul/li[6]/div/label/span[3]").click()
        driver.find_element_by_xpath("//button[@type='submit']").click()
        driver.find_element_by_xpath("//li[@id='add_page_icon']/a/span").click()
        driver.find_element_by_id("id_title").click()
        ...
        driver.find_element_by_xpath("//form[@id='form_matrix']/div").click()

...
class PruebaCheckListNormal(unittest.TestCase):
    def setUp(self):
    ...
    def test_prueba_check_list_normal(self):
        driver = self.driver
        ...
        driver.find_element_by_id("id_title").send_keys("PruebacheckListNormal")
        driver.find_element_by_css_selector("span.fa.fa-2x.fa-arrow-right").click()
        driver.find_element_by_xpath("//div[@id='menu_questions']/ul/li[7]/a/span[2]").click()
        driver.find_element_by_id("id_title").click()
        driver.find_element_by_id("id_title").clear()
        driver.find_element_by_id("id_title").send_keys("1")

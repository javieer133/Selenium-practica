...
class PruebaErrorCheckListNormal(unittest.TestCase):
    def setUp(self):
    ...
    def test_prueba_error_check_list_normal(self):
        driver = self.driver
        ...
        driver.find_element_by_id("id_title").send_keys("PruebaErrorCheckListNormal")

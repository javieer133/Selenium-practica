...
class EscalaDeCaras3carasSimpleAll(unittest.TestCase):
    def setUp(self):
    ...
    def test_escala_de_caras3caras_simple_all(self):
        driver = self.driver
        ...
        Select(driver.find_element_by_id("id_scale_label")).select_by_visible_text(u"No / Sí")
        driver.find_element_by_id("id_scale_label").click()
        driver.find_element_by_css_selector("div.botonera.clearfix > button.btn.btn-success.pull-right").click()
        driver.find_element_by_css_selector("a.add-scale-modal > span.label").click()
        driver.find_element_by_id("id_title").click()
        ...
        driver.find_element_by_id("id_title").send_keys("Pregunta de prueba")
        driver.find_element_by_id("id_scale_label").click()
        Select(driver.find_element_by_id("id_scale_label")).select_by_visible_text("Nunca / Siempre (3)")
        driver.find_element_by_id("id_scale_label").click()
        driver.find_element_by_css_selector("div.botonera.clearfix > button.btn.btn-success.pull-right").click()
        driver.find_element_by_css_selector("a.add-scale-modal > span.label").click()
        driver.find_element_by_id("id_title").click()
        ...
        driver.find_element_by_id("id_title").send_keys("Pregunta de prueba")
        driver.find_element_by_id("id_scale_label").click()
        Select(driver.find_element_by_id("id_scale_label")).select_by_visible_text("No lo describe para nada / Lo describe completamente")
        driver.find_element_by_id("id_scale_label").click()
        driver.find_element_by_css_selector("div.botonera.clearfix > button.btn.btn-success.pull-right").click()
        driver.find_element_by_css_selector("a.add-scale-modal > span.label").click()
        driver.find_element_by_id("id_title").click()
        ...
        driver.find_element_by_id("id_title").send_keys("Pregunta de prueba")
        driver.find_element_by_id("id_scale_label").click()
        Select(driver.find_element_by_id("id_scale_label")).select_by_visible_text("No lo conozco / Lo conozco")
        driver.find_element_by_id("id_scale_label").click()
        driver.find_element_by_css_selector("div.botonera.clearfix > button.btn.btn-success.pull-right").click()

...
class CrearPautaEscalaDeNumeros3(unittest.TestCase):
    def setUp(self):
    ...
    def test_crear_pauta_escala_de_numeros3(self):
        driver = self.driver
        driver.get("https://qservus-qa.redcalidad.com/newsfeed/")
        driver.find_element_by_xpath("//li[@id='surveys']/a/span").click()
        driver.find_element_by_xpath("//a[@id='template_new_2']/span").click()
        driver.find_element_by_id("id_title").click()
        driver.find_element_by_id("id_title").clear()
        driver.find_element_by_id("id_title").send_keys("CrearPauta_EscalaDeNumeros_3")
        driver.find_element_by_id("id_subtitle").click()
        driver.find_element_by_id("id_subtitle").clear()
        driver.find_element_by_id("id_subtitle").send_keys("CrearPauta_EscalaDeNumeros_3")
        ...
        driver.find_element_by_id("id_help_text").send_keys("CrearPauta_EscalaDeNumeros_3")

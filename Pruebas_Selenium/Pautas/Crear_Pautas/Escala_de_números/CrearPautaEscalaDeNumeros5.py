...
class CrearPautaEscalaDeNumeros5(unittest.TestCase):
    def setUp(self):
    ...
    def test_crear_pauta_escala_de_numeros5(self):
        driver = self.driver
        ...
        driver.find_element_by_id("id_title").send_keys("CrearPauta_EscalaDeNumeros_5")
        driver.find_element_by_id("id_subtitle").click()
        driver.find_element_by_id("id_subtitle").clear()
        driver.find_element_by_id("id_subtitle").send_keys("CrearPauta_EscalaDeNumeros_5")
        ...
        driver.find_element_by_id("id_help_text").send_keys("CrearPauta_EscalaDeNumeros_5")
        ...
        driver.find_element_by_id("id_no_apply_label").send_keys("N/A")

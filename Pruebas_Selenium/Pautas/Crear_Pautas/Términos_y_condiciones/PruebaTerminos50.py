...
class PruebaTerminos50(unittest.TestCase):
    ...
    def test_prueba_terminos50(self):
        driver = self.driver
        ...
        driver.find_element_by_id("id_title").send_keys("PruebaTeminos50")
        driver.find_element_by_css_selector("div.colors.red.clearfix.template_first_page").click()
        ...
        driver.find_element_by_id("id_title").click()
        driver.find_element_by_id("id_title").clear()
        driver.find_element_by_id("id_title").send_keys("prueba 2")
        driver.find_element_by_css_selector("div.modal-body").click()

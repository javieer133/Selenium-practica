...
class PruebaErrorTerminosNormal(unittest.TestCase):
    ...
    def test_prueba_error_terminos_normal(self):
        driver = self.driver
        ...
        driver.find_element_by_id("id_title").send_keys("PruebaErrorTerminosNormal")

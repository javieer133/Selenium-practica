...
class PruebaErrorTerminosArchivoErroneo(unittest.TestCase):
    def setUp(self):
    ...
    def test_prueba_error_terminos_archivo_erroneo(self):
        driver = self.driver
        ...
        driver.find_element_by_id("id_title").send_keys("PruebaErrorTerminosArchivoErroneo")
        ...
        driver.find_element_by_id("id_question_attachment").send_keys("")

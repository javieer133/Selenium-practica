...
class PruebaTerminosNormal(unittest.TestCase):
    ...
    def test_prueba_terminos_normal(self):
        driver = self.driver
        ...
        driver.find_element_by_id("id_title").send_keys("PruebaTerminosNormal")
        ...
        driver.find_element_by_id("id_title").click()
        driver.find_element_by_id("id_title").clear()
        driver.find_element_by_id("id_title").send_keys("prueba 4")

...
class PruebaTerminos100(unittest.TestCase):
    ...
    def test_prueba_terminos100(self):
        print(self.pdf_path)
        driver = self.driver
        ...
        driver.find_element_by_id("id_title").send_keys("PruebaTerminos100")
        ...
        driver.find_element_by_id("id_title").click()
        driver.find_element_by_id("id_title").clear()
        driver.find_element_by_id("id_title").send_keys("prueba 1")

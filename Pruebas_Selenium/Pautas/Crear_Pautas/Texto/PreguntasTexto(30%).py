...
class PreguntasTexto30(unittest.TestCase):
    def setUp(self):
    ...
    def test_preguntas_texto30(self):
        driver = self.driver
        ...
        driver.find_element_by_xpath("//form[@id='survey_template_create']/div[2]/div/ul/li").click()

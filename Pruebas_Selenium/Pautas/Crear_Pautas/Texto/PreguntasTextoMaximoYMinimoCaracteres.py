...
class PreguntasTextoMaximoYMinimoCaracteres(unittest.TestCase):
    def setUp(self):
    ...
    def test_preguntas_texto_maximo_y_minimo_caracteres(self):
        driver = self.driver
        ...
        driver.find_element_by_id("id_title").send_keys("Validacion maximo y minimos")
        ...
        driver.find_element_by_id("id_min_length").send_keys("50")
        driver.find_element_by_id("id_max_length").click()
        driver.find_element_by_id("id_max_length").clear()
        driver.find_element_by_id("id_max_length").send_keys("30")
        driver.find_element_by_xpath("//button[@type='submit']").click()
        driver.find_element_by_id("id_min_length").click()
        driver.find_element_by_id("id_max_length").click()
        driver.find_element_by_id("id_max_length").clear()
        driver.find_element_by_id("id_max_length").send_keys("50")
        driver.find_element_by_xpath("//button[@type='submit']").click()

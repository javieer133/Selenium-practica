...
class PreguntasTextoCamposObligatorios(unittest.TestCase):
    def setUp(self):
    ...
    def test_preguntas_texto_campos_obligatorios(self):
        driver = self.driver
        ...
        driver.find_element_by_id("id_title").send_keys("Campos necesarios")
        driver.find_element_by_xpath("//button[@type='submit']").click()
        driver.find_element_by_link_text("Texto").click()
        driver.find_element_by_xpath("//button[@type='submit']").click()
        driver.find_element_by_id("id_title").clear()
        driver.find_element_by_id("id_title").send_keys("campo ocupado")
        driver.find_element_by_id("id_su_question_group_tpl").click()
        Select(driver.find_element_by_id("id_su_question_group_tpl")).select_by_visible_text("---------")

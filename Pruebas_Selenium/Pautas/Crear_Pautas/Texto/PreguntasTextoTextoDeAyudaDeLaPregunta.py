...
class PreguntasTextoTextoDeAyudaDeLaPregunta(unittest.TestCase):
    def setUp(self):
    ...
    def test_preguntas_texto_texto_de_ayuda_de_la_pregunta(self):
        driver = self.driver
        ...
        driver.find_element_by_id("id_title").send_keys("Texto Ayuda")
        driver.find_element_by_xpath("//button[@type='submit']").click()
        driver.find_element_by_link_text("Texto").click()
        driver.find_element_by_xpath("//div[@id='modal']/div/div/div[2]").click()
        driver.find_element_by_id("id_title").click()
        driver.find_element_by_id("id_title").clear()
        driver.find_element_by_id("id_title").send_keys("Texto Ayuda")
        driver.find_element_by_id("id_help_text").click()
        driver.find_element_by_id("id_help_text").clear()
        driver.find_element_by_id("id_help_text").send_keys("Este es el campo de texto ayuda")
        driver.find_element_by_xpath("//button[@type='submit']").click()

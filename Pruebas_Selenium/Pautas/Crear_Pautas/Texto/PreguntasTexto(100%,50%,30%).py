...
class PreguntasTexto1005030(unittest.TestCase):
    def setUp(self):
    ...
    def test_preguntas_texto1005030(self):
        driver = self.driver
        ...
        driver.find_element_by_id("id_title").send_keys("Texto 100%, 50%, 30%")
        driver.find_element_by_xpath("//button[@type='submit']").click()
        driver.find_element_by_xpath("//div[@id='menu_questions']/ul/li[2]/a/span[2]").click()
        driver.find_element_by_id("id_title").click()
        driver.find_element_by_id("id_title").clear()
        driver.find_element_by_id("id_title").send_keys("texto100%")
        ...
        driver.find_element_by_id("id_title").click()
        driver.find_element_by_id("id_title").clear()
        driver.find_element_by_id("id_title").send_keys("texto50%")
        driver.find_element_by_id("id_priority").click()
        ...
        driver.find_element_by_id("id_title").click()
        driver.find_element_by_id("id_title").clear()
        driver.find_element_by_id("id_title").send_keys("texto30%")
        driver.find_element_by_id("id_priority").click()

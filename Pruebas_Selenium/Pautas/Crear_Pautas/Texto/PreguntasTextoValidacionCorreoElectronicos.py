...
class PreguntasTextoValidacionCorreoElectronicos(unittest.TestCase):
    def setUp(self):
    ...
    def test_preguntas_texto_validacion_correo_electronicos(self):
        driver = self.driver
        ...
        driver.find_element_by_id("id_title").send_keys("Texto Validacion Correo Electronico")

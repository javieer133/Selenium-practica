...
class PreguntasFecha1005030(unittest.TestCase):
    def setUp(self):
    ...
    def test_preguntas_fecha1005030(self):
        driver = self.driver
        ...
        driver.find_element_by_id("id_title").send_keys("fecha 100%, 50%, 30%")
        driver.find_element_by_xpath("//button[@type='submit']").click()
        driver.find_element_by_link_text("Fecha").click()
        driver.find_element_by_id("id_title").click()
        driver.find_element_by_id("id_title").clear()
        driver.find_element_by_id("id_title").send_keys("fecha100%")
        ...
        driver.find_element_by_id("id_title").click()
        driver.find_element_by_id("id_title").clear()
        driver.find_element_by_id("id_title").send_keys("fecha50%")
        driver.find_element_by_id("id_priority").click()
        ...
        driver.find_element_by_id("id_title").click()
        driver.find_element_by_id("id_title").clear()
        driver.find_element_by_id("id_title").send_keys("fecha30%")
        driver.find_element_by_id("id_priority").click()

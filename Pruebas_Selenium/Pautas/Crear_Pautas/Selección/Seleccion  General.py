...
class BorrarDespues(unittest.TestCase):
    ...
    def test_borrar_despues(self):
        ...
        driver.find_element_by_id("id_min_selection").send_keys("0")
...
#Clic sobre guardar laternativa
        ...
        #driver.find_element_by_id("id_image").send_keys("C:\Users\H\Desktop\Nueva\descarga.png")
...
#Clic sobre guardar laternativa
        ...
        driver.find_element_by_id("id_title").click()
        driver.find_element_by_id("id_title").clear()
        driver.find_element_by_id("id_title").send_keys("Seleccion Unica")
        ...
        driver.find_element_by_id("id_su_question_type_id").click()
        Select(driver.find_element_by_id("id_su_question_type_id")).select_by_visible_text("Respuesta única")
        driver.find_element_by_id("id_su_question_type_id").click()
        ...
        driver.find_element_by_xpath("//div[@id='page_1']/div[2]/div[2]/ul/li/a").click()
        driver.find_element_by_id("id_name").click()
        driver.find_element_by_id("id_name").clear()
        driver.find_element_by_id("id_name").send_keys("Preg uno")
...
#Clic sobre guardar laternativa
        ...
        driver.find_element_by_xpath("//div[@id='page_1']/div[2]/div[3]/ul/li/a").click()
        driver.find_element_by_id("id_name").click()
        driver.find_element_by_id("id_name").clear()
        driver.find_element_by_id("id_name").send_keys("Preg uno")

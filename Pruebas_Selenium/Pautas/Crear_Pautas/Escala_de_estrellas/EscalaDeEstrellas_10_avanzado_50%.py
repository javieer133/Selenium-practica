...
class EscalaDeEstrellas10Avanzado30(unittest.TestCase):
    def setUp(self):
    ...
    def test_escala_de_estrellas10_avanzado30(self):
        driver = self.driver
        ...
        Select(driver.find_element_by_id("id_su_question_type_id")).select_by_visible_text("10 estrellas")
        driver.find_element_by_id("id_su_question_type_id").click()
        driver.find_element_by_id("id_title").click()
        driver.find_element_by_id("id_title").clear()
        driver.find_element_by_id("id_title").send_keys("aksjdaksjd")

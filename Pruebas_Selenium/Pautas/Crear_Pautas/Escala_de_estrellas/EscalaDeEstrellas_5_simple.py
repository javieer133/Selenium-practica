...
class EscalaDeEstrellas5Simple(unittest.TestCase):
    def setUp(self):
    ...
    def test_escala_de_estrellas5_simple(self):
        driver = self.driver
        ...
        driver.find_element_by_id("id_title").click()
        driver.find_element_by_id("id_title").clear()
        driver.find_element_by_id("id_title").send_keys("Enunciado de la preguuuntaa")

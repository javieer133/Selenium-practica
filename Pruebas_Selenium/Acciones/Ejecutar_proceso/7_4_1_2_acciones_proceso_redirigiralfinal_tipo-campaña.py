...
class 7412AccionesProcesoRedirigiralfinalTipoCampanA(unittest.TestCase):
    def setUp(self):
    ...
    def test_7412_acciones_proceso_redirigiralfinal_tipo_campan_a(self):
        driver = self.driver
        driver.get(self.base_url + "/newsfeed/")
        driver.find_element_by_css_selector("span.fa.fa-actions").click()
        driver.find_element_by_xpath("//div[@id='content']/div[3]/div/ul/li[4]/a/p").click()
        ...
        driver.find_element_by_id("id_redirect_link").clear()
        driver.find_element_by_id("id_redirect_link").send_keys("https://www.redcalidad.com/")

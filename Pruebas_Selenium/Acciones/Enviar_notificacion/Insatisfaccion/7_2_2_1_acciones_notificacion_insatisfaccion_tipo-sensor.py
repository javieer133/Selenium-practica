...
class 7221AccionesNotificacionInsatisfaccionTipoSensor(unittest.TestCase):
    def setUp(self):
    ...
    def test_7221_acciones_notificacion_insatisfaccion_tipo_sensor(self):
        driver = self.driver
        ...
        Select(driver.find_element_by_id("id_interval_time")).select_by_visible_text("05:00")

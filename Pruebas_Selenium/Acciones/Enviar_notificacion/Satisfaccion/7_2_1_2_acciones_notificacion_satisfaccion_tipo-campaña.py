...
class 7212AccionesNotificacionSatisfaccionTipoCampanA(unittest.TestCase):
    def setUp(self):
    ...
    def test_7212_acciones_notificacion_satisfaccion_tipo_campan_a(self):
        driver = self.driver
        ...
        driver.find_element_by_css_selector("#id_receivers > li > label").click()

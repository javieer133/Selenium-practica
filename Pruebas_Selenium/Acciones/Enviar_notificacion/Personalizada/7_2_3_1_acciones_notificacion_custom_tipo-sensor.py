...
class 7231AccionesNotificacionCustomTipoSensor(unittest.TestCase):
    def setUp(self):
    ...
    def test_7231_acciones_notificacion_custom_tipo_sensor(self):
        driver = self.driver
        driver.get(self.base_url + "/newsfeed/")
        driver.find_element_by_css_selector("span.fa.fa-actions").click()
        driver.find_element_by_link_text(u"Enviar notificaciónAcciones para generar alertas y notificaciones").click()

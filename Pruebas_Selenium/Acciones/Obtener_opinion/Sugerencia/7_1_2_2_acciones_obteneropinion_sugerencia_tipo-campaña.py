...
class 7122AccionesObteneropinionSugerenciaTipoCampanA(unittest.TestCase):
    def setUp(self):
    ...
    def test_7122_acciones_obteneropinion_sugerencia_tipo_campan_a(self):
        driver = self.driver
        ...
        driver.find_element_by_xpath("//div[@id='content']/div[3]/div/ul/li[2]/a/h2").click()
        ...
        Select(driver.find_element_by_id("id_su_question")).select_by_visible_text(u"Cuán interesante considera usted el libro \"Batallas Ganadas\"?")

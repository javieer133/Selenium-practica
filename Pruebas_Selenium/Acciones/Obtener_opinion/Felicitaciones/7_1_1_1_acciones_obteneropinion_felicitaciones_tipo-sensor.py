...
class 7111AccionesObteneropinionFelicitacionesTipoSensor(unittest.TestCase):
    def setUp(self):
    ...
    def test_7111_acciones_obteneropinion_felicitaciones_tipo_sensor(self):
        driver = self.driver
        ...
        driver.find_element_by_link_text("FelicitacionesEncuestas configuradas: 0").click()
